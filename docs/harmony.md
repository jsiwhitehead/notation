...
7. Evaluate candidate intra-segment harmonic slice boundaries from authored onsets when projection asks for segment-local slice analysis, preferring one unsplit segment unless a stronger split clearly improves harmonic fit.
